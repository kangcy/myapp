...
var base = new function() {
	...
	this.ShowUser = function(id) {
		mui(id).on('tap', '.user', function(event) {
			...
			base.ShowTemplate("user" + userNumber, "user.html", "Ta的资料", JSON.stringify(param), "", "0px");*/
		});
	}
	 ...
	 * isLazy:是否图片懒加载
	 */
	this.AppendUser = function(item, isSignature, isFollow, isDelete, deleteName, isDistance, isLazy) {
		var div = document.createElement('div');
