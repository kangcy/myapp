...
var base = new function() {
	...
	//打开模板页
	this.ShowTemplate = function(id, url, title, param) {
		if(base.RepeatAction()) {
			return;
		}
		//base.GetView("template").show(base.ShowAnimate(), base.AnimateDuration);
		plus.webview.show("template", base.ShowAnimate(), base.AnimateDuration, function() {}, {});
