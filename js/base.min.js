...
var base = new function() {
	...
	this.AppendUser = function(item, isSignature, isDistance, isLazy, showAnimate, btn) {
		...
		if(btn > 0) {
			...
			if(btn == 1) {
				...
				model.push('<div class="blackrelease"><img src="../images/base/follow1.png" class="fr" style="width:3.8rem !important;" /></div>');
			}
			model.push('</div>');
		}
		model.push('</div>');
	...
	this.ShowTemplate = function(id, url, title, param, animate, top) {
		...
		var view = plus.webview.create("template.html", "template" + base.GetUid(), {
			top: "0px",
			bottom: "0px",
