...
var base = new function() {
	...
	this.ShowUser = function(id) {
		mui(id).on('tap', '.user', function(event) {
			...
			base.ShowTemplate("user" + userNumber, "user.html", "Ta的资料", JSON.stringify(param));
		});
	}
	...
	//打开模板页
	this.ShowTemplate = function(id, url, title, param, animate) {
		if(base.RepeatAction()) {
			return;
		}
		base.GetView("template").evalJS("InitPage('" + id + "', '" + url + "', '" + title + "', '" + param + "')");
		base.GetView("template").show(animate ? animate : base.ShowAnimate(), base.AnimateDuration);
	}
}
