...
function AppendArticle(userNumber, item, ismy, isuser, islazyload, isdel) {
	...
	if(ismy) {
		...
		model.push('<div class="mui-media-body f14 mt0" style="position:relative;"><span class="user c333" userid="' + item.UserNumber + '"nickname="' + base.UnUnicodeText(item.NickName) + '"avatar="' + item.Avatar + '"cover="' + item.Cover + '">' + base.UnUnicodeText(item.NickName) + '</span><p class="f10 full blue mt5">');
	...
	//model.push('<span class="fl mt1">浏览' + item.Views + '次</span>');
