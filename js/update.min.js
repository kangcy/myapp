...
function Check_Update(callback) {
	plus.runtime.getProperty(plus.runtime.appid, function(inf) {
		...
		HttpGet(base.RootUrl + "System/CheckUpdate", {
			version: version,
			source: version.substring(version.toString().length - 1, version.toString().length),
			client: client
		}, function(data) { 
