...
(function(document, window, $) {
    ...
    function init(self, source, options) {
		...
		var top='<div style="width:100%;height:50px;line-height:50px;"><span style="float:left;margin-left:15px;" onclick="EditorClose()">取消</span><span style="float:right;margin-right:15px;" onclick="EditorSubmit()">发表</span></div>';
        
		app = $('<div/>', {"class" : source.attr("class"), role: "application"}).addClass("emojionearea").html(top+app);
	...
	EmojioneArea.prototype.getHtml = function() {
